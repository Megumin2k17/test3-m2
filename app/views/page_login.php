...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="front/img/favicon/apple-touch-icon.png">
    <link rel="icon" type="front/image/png" sizes="32x32" href="front/img/favicon/favicon-32x32.png">
    <link rel="mask-icon" href="front/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
    <link rel="stylesheet" media="screen, print" href="front/css/page-login-alt.css">
</head>
<body>
    <div class="blankpage-form-field">
        <div class="page-logo m-0 w-100 align-items-center justify-content-center rounded border-bottom-left-radius-0 border-bottom-right-radius-0 px-4">
            <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                <img src="front/img/logo.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
            ...
            <form action="/login" method="POST">
                ...
                <div class="form-group text-left">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label name="rememberme" class="custom-control-label" for="rememberme">Запомнить меня</label>
                    </div>
                </div>
    ...
    <video poster="front/img/backgrounds/clouds.png" id="bgvid" playsinline autoplay muted loop>
        <source src="front/media/video/cc.webm" type="video/webm">
        <source src="front/media/video/cc.mp4" type="video/mp4">
    </video>
