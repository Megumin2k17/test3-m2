                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input name="info[name]" type="text" id="simpleinput" class="form-control">
                            </div>

                            <!-- title -->
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Место работы</label>
                                <input name="info[workplace]" type="text" id="simpleinput" class="form-control">
                            </div>

                            <!-- tel -->
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Номер телефона</label>
                                <input name="info[phone]" type="text" id="simpleinput" class="form-control">
                            </div>

                            <!-- address -->
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Адрес</label>
                                <input name="info[address]" type="text" id="simpleinput" class="form-control">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                        ...
                                        <input name="social[vk]" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <!-- telegram -->
                                    <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                        ...
                                        <input name="social[telegram]" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <!-- instagram -->
                                    <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                        ...
                                        <input name="social[instagram]" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                    </div>
                                </div>
